    ...
    <div className="navBar">
      <div className="navbar-container">
        <ul className="navbar-items">
          ...
          <li
            className={`navbar-item ${activeSection === "education" ? "active" : ""}`}
          ...
          <li
            className={`navbar-item ${activeSection === "experience" ? "active" : ""}`}
